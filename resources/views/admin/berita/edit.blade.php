...
@section('title', 'Edit Berita Prestasi')
    ...
    <div class="col-12">
        <div class="d-flex justify-content-between align-items-center">
            <h2 class="h4 mb-0 text-primary">
                <i class="fa-solid fa-pen-to-square me-2"></i> Edit Berita
            </h2>
    ...
    <div class="col-md-8">
        <div class="card shadow-sm border-0">
            <div class="card-header bg-white pt-3 pb-2">
                <h5 class="mb-0"><i class="fa-solid fa-pen me-2 text-warning"></i> Ubah Detail Berita</h5>
            </div>
            <div class="card-body p-4">
                ...
                <form action="{{ route('admin.berita.update', $berita->id) }}" method="POST">
                    ...
                    <div class="mb-4">
                        ...
                        <textarea class="form-control" id="konten" name="konten" rows="8" required>{{ old('konten', $berita->konten) }}</textarea>
                    </div>
                    ...
                    <div class="d-grid gap-2 mt-4 d-md-flex justify-content-md-end">
                        ...
                        <button type="submit" class="btn btn-warning px-4 text-dark fw-bold">
                            <i class="fa-solid fa-save me-1"></i> Update Berita
                        </button>
                    </div>
                </form>
            </div>
